...
$aSiteHost['Seat']='IDC';
//網站中文名稱
$aSiteHost['ch_site']='RD';
//網站名稱
$aSiteHost['site_name']='rdfast.net';
//站台類型
$aSiteHost['draws']='純快';
//站台名稱
...
//站台資料庫名稱
$aSiteHost['DBName']='fast_lottery';
//線路名稱
$sSite_name=$aSiteHost['site_name'];
$aSiteHost['Line'][]=$sSite_name;
//$aSiteHost['Line'][]='ag.'.$sSite_name;
//$aSiteHost['Line'][]='1.'.$sSite_name;
//看Process用帳密
/*
	$aSiteHost['PSLogin']:{
		一般使用者:{
